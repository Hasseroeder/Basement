...
const injectors = [
	{
		...
		load: async () => {
			...
			await Promise.all([
				loadJson('/weapon/json/weapons.json').then((items) =>
					gridInjector({
	...
	},
	{
		...
		load: async () => {
			const blinkies = randomElements(4, [
				...
				{
					file: 'rbot_blinkie.gif',
					href: 'https://discord.com/oauth2/authorize?client_id=519287796549156864&scope=bot%20applications.commands&permissions=347200',
				},
